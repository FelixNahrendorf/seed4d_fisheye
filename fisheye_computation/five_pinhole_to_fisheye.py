...
import cv2
import os
from equidistant_projection import EquidistantProjection
...
def compute_fisheye_rays(fisheye_image_path:str)-> None:
    ...
    filename = f"/seed4d/fisheye_computation/images/rgb_fisheye_rays3d.ply"
...
def compute_five_pinhole_rays(five_pinhole_path: str) -> None:
    ...
    filename = f"/seed4d/fisheye_computation/images/rgb_five_front_rays3d.ply"
    ...
    filename = f"/seed4d/fisheye_computation/images/rgb_five_left_rays3d.ply"
   ...
   # Right camera
    ...
    filename = f"/seed4d/fisheye_computation/images/rgb_five_right_rays3d.ply"
    ...
    filename = f"/seed4d/fisheye_computation/images/rgb_five_top_rays3d.ply"
    ...
    filename = f"/seed4d/fisheye_computation/images/rgb_five_bottom_rays3d.ply"
...
def main():
    ...
    fisheye_image_path = f"/seed4d/fisheye_computation/images/rgb_001.jpg"
    compute_fisheye_rays(fisheye_image_path=fisheye_image_path)
    five_pinhole_path  = f"/seed4d/fisheye_computation/images/five_rgb_001.jpg"
